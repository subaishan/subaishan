...
<img align="right" width="200" src="./images/xiaoyu.png">

我是一名来自中国的大学生，一个在AI和全栈领域探索的开发者，技术上Python是我的主力，YOLO是我的老朋友，使用Django和Flask也写过正经的项目，能搭建出能用的后端。前端使用过Vue，数据库碰过MySQL和Redis，嵌入式也使用C写过一些东西。各层都摸过一些，不算深，但是能串起来做一个完整的东西

我喜欢开源和所有有趣的事物，并且想要尝试将AI融合进去。所有我希望自己能成为一个能把想法变成作品的人，不管是一个工具，一个有意思的小点子。技术只是手段，做出「别人以后会记得的东西」才是目的。
